  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center space-x-4">
        <h2 className="text-3xl font-bold text-gray-900">Azure Web App Tutorial</h2>
      </div>

      <p className="text-lg text-gray-700">
        This tutorial will guide you through setting up and deploying a full-stack application with both client and
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
        ...
        <div className="flex justify-center">
          {/* Method 1: Using public folder (recommended for static assets) */}
          <img
            src="/azure-swa-overview.svg"
            alt="Azure Static Web Apps Architecture Diagram showing the flow from React app and API functions through GitHub to Azure hosting"
            className="max-w-full h-auto rounded-lg shadow-md"
          />
        </div>
        <p className="text-sm text-gray-600 mt-3 text-center">
          <em>Figure 1: Azure Static Web Apps deployment architecture</em>
        </p>
      </div>
      ...
      <div className="bg-blue-50 border-l-4 border-blue-400 p-4">
        ...
        <ul className="mt-2 text-blue-800 space-y-1">
          <li>• How to configure Azure Static Web Apps</li>
          <li>• Setting up GitHub Actions for CI/CD</li>
          <li>• Deploying React frontend and Node.js backend</li>
